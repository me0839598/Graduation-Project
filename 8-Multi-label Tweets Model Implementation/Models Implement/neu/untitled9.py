...
feature_vector = ["freq_anticipation","bi_anticipation","doc2vec_anticipation", "lex_Anticipation", "hlex_anticipation",
...
em = [ "anticipation", "surprise", "trust"]
...
mlb = MultiLabelBinarizer(
    classes=("anticipation", "surprise", "trust"))
...
"""
##################################################################################################
# Voting and Average Ensemble Techniques
def avg_predict(X):
...
plot_test_res(testdf, test_pred)
test_submit(test_pred, "avg_neutral")
...
test_submit(test_pred, "voting_neutral")
plot_test_res(testdf, test_pred)
"""
...
test_submit(test_predict, "nb_neutral")