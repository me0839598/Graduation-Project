...
em = ["anger", "disgust", "fear","pessimism", "sadness"]
...
mlb = MultiLabelBinarizer(
    classes=("anger", "disgust", "fear","pessimism", "sadness"))
...
plot_test_res(testdf, test_pred)
test_submit(test_pred, "avg_negative")
...
test_submit(test_pred, "voting_negative")
plot_test_res(testdf, test_pred)
...
test_submit(test_predict, "nb_negative")