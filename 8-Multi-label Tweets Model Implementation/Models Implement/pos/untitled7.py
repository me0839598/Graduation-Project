...
feature_vector = ["freq_joy","bi_joy","doc2vec_joy", "lex_Joy","hlex_joy",
...
plot_test_res(testdf, test_pred)
test_submit(test_pred, "avg_positive")
...
test_submit(test_pred, "voting_positive")
plot_test_res(testdf, test_pred)
"""
...
test_submit(test_predict, "nb_positive")