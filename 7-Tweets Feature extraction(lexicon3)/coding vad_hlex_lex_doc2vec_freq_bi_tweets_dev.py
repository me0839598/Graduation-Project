...
traindf=pd.read_csv('C:\\Users\\Mohamad\\Desktop\\t\\hlex_lex_doc2vec_freq_bi_tweets_train_final.csv',encoding="utf-8")
devdf=pd.read_csv('C:\\Users\\Mohamad\\Desktop\\t\\hlex_lex_doc2vec_freq_bi_tweets_dev_final.csv',encoding="utf-8")
testdf=pd.read_csv('C:\\Users\\Mohamad\\Desktop\\t\\hlex_lex_doc2vec_freq_bi_tweets_test_final.csv',encoding="utf-8")
traindf.head(10)
lexdf=pd.read_csv('C:\\Users\\Mohamad\\Desktop\\t\\NRC-VAD-Lexicon.txt',encoding='utf-8',sep="\t")
lexdf.head(10)
...
traindf.to_csv("vad_hlex_lex_doc2vec_freq_bi_tweets_train.csv",index=False,encoding="utf-8")
devdf.to_csv("vad_hlex_lex_doc2vec_freq_bi_tweets_dev.csv",index=False,encoding="utf-8")
testdf.to_csv("vad_hlex_lex_doc2vec_freq_bi_tweets_test.csv",index=False,encoding="utf-8")