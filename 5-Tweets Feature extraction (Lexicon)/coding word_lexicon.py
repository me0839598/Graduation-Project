...
emotion_lexicon=pd.read_csv('C:\\Users\\Mohamad\\Desktop\\v\\NRC-Emotion-Lexicon.csv ',encoding='utf-8',sep="," )
...
traindf=pd.read_csv('C:\\Users\\Mohamad\\Desktop\\v\\doc2vec_freq_bi_tweets_training.csv',encoding="utf-8")
devdf=pd.read_csv('C:\\Users\\Mohamad\\Desktop\\v\\doc2vec_freq_bi_tweets_dev.csv',encoding="utf-8")
testdf=pd.read_csv('C:\\Users\\Mohamad\\Desktop\\v\\doc2vec_freq_bi_tweets_test.csv',encoding="utf-8")
#view columns name
...
traindf.to_csv("lex_doc2vec_freq_bi_tweets_train_final.csv",index=False,encoding="utf-8")
devdf.to_csv("lex_doc2vec_freq_bi_tweets_dev_final.csv",index=False,encoding="utf-8")
testdf.to_csv("lex_doc2vec_freq_bi_tweets_test_final.csv",index=False,encoding="utf-8")
